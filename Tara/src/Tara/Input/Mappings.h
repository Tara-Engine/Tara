...
#define TARA_JOYSTICK_HAT_RIGHT_UP           (TARA_JOYSTICK_HAT_RIGHT | TARA_JOYSTICK_HAT_UP)
#define TARA_JOYSTICK_HAT_RIGHT_DOWN         (TARA_JOYSTICK_HAT_RIGHT | TARA_JOYSTICK_HAT_DOWN)
#define TARA_JOYSTICK_HAT_LEFT_UP            (TARA_JOYSTICK_HAT_LEFT  | TARA_JOYSTICK_HAT_UP)
#define TARA_JOYSTICK_HAT_LEFT_DOWN          (TARA_JOYSTICK_HAT_LEFT  | TARA_JOYSTICK_HAT_DOWN)
